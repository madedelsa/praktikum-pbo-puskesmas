...
public class PanelCover extends javax.swing.JPanel {
    ...
    GradientPaint gra = new GradientPaint(0, 0, new Color(169, 181, 223), 0, getHeight(), new Color(45, 51, 107));
    g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description1.setText("and start journey");
                button.setText("SIGN UP");
            } else {
                title.setText("Welcome Back!");
                description.setText("To keep connected with us please");
                description1.setText("login with your Username");
                button.setText("SIGN IN");
            }
            this.isLogin = login;
        }
