...
public class AddLansia extends javax.swing.JFrame {
    ...
    public AddLansia() {  // Add this default constructor
        initComponents();
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            controller.create(nama, usia, gulaDarah, tdDiastolik, tdSistolik, catatan);
            JOptionPane.showMessageDialog(this, "Data berhasil ditambahkan!");

            if (tableLansia != null) {
                tableLansia.loadTable(); // Refresh the table in TableLansia
                tableLansia.setVisible(true); // Show TableLansia
            } else {
                // If tableLansia is null, create a new instance (less ideal)
                TableLansia newTableFrame = new TableLansia();
                newTableFrame.setVisible(true);
            }
            this.dispose(); // Close AddLansia
